...
public class PowerSet2 {
	/**
	 * Returns a List of int[]'s representing all subsets of {0,1,2,...,n-1}.
	 * For example one input {0,1,2} the method returns { {} {0},{1},{2}, {0,1},
	 * {1,2}, {0,2}, {0,1,2} }
	 */
	private static List<int[]> powerset(int n) {
		if (n < 0)
			return null;
	...
	public static void main(String[] args) {
		List<int[]> allsubsets = powerset(4);
